...
function KTBLOG() {
  const [entries, updateEntries] = useState(
    Array<KTBlogPostProps>(
      {
        content:
          "There are no blog posts yet. Please check back in later to see more content.",
        postId: 1,
        title: "Basic title",
    ...
    <div>
      <div className="header">
        ...
        <button
          ...
          className="btn"
        >
          {pageState == blogState.Default ? "Refresh Posts" : "Email Me!"}
        </button>
        <button
          onClick={() => {
            if (pageState == blogState.Default) {
